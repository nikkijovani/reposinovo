    ...
    <body class="container">
        ...
        <div class="page-header">
            ...
            <div>
                ...
                <%
                    if (produto.temPromoValida()) {
                %>
                De <strike><%=produto.getVlUnidade()%></strike><br>
                Por <%=produto.getVlPromocao()%><br>
                <%
                } else {
                %>
                ...
                <form method="post" action="compra" > 
                    ...
                    <div class="button">
                        <!-- TODO criar outro input para capturar a QUANTIDADE desse produto -->
                        <input type="number" name="treco" value="0" >
                        <input type="hidden" name="coisa" value="<%=produto.getIdProduto()%>">
